...
urlpatterns = [
    ...
    path('disponibilites/', views.disponibilites_view, name='disponibilites'),
    path('disponibilites/<uuid:dispo_id>/', views.disponibilite_delete, name='disponibilite-delete'),
    path('exceptions-dispo/', views.exceptions_dispo_view, name='exceptions-dispo'),
    path('exceptions-dispo/<uuid:exc_id>/', views.exception_dispo_delete, name='exception-dispo-delete'),
    path('portal/disponibilites/', views.portal_disponibilites, name='portal-disponibilites'),
    path('portal/reserver/', views.portal_reserver_seance, name='portal-reserver'),
    path('auth/google-calendar/status/',     views.google_calendar_status,     name='gcal-status'),
    path('auth/google-calendar/connect/',    views.google_calendar_connect,    name='gcal-connect'),
